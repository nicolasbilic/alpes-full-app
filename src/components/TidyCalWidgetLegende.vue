...
<template>
  ...
  <!-- Bouton personnalisé -->
  <button class="tidycal-button" @click="loadWidget">
    Je réserve
  </button>

  <!-- Conteneur du widget -->
  <div v-if="showWidget" class="tidycal-widget-container" ref="tidyWidget">
    <button class="close-button" @click="closeWidget" aria-label="Fermer le widget">
      <svg class="close-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true">
        <path d="M18 6L6 18M6 6l12 12" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
          fill="none" />
      </svg>
    </button>
    <div class="tidycal-embed" data-path="nicolasbilicdev/forfait-legende"></div>
  </div>
</template>
